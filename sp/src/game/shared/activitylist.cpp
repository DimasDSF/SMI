...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY( ACT_RUN_PASSIVE );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_PASSIVE );
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRAWEMPTY );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HOLSTER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HOLSTEREMPTY );
...
//===========================
	...
	REGISTER_SHARED_ACTIVITY( ACT_SHOTGUN_PUMP_EMPTY);
	REGISTER_SHARED_ACTIVITY( ACT_SHOTGUN_PUMP_NOSHELL);
	REGISTER_SHARED_ACTIVITY( ACT_SHOTGUN_PUMP_NOSHELL_EMPTY);
