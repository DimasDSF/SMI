...
void CAI_BaseNPC::InitDefaultScheduleSR(void)
{
	...
	ADD_DEF_SCHEDULE( "SCHED_BACK_AWAY_FROM_MELEE_ENEMY_FAIL",	SCHED_BACK_AWAY_FROM_MELEE_ENEMY_FAIL);
...
//	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_NONE);
	...
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_BACK_AWAY_FROM_MELEE_ENEMY_FAIL);
...
(
	...
	"	Tasks"
			// If I can't back away from the enemy try to get behind him
	"		TASK_SET_FAIL_SCHEDULE			SCHEDULE:SCHED_BACK_AWAY_FROM_MELEE_ENEMY_FAIL"
	"		TASK_STOP_MOVING							0"
//	"		TASK_SET_TOLERANCE_DISTANCE					24"
	"		TASK_STORE_ENEMY_POSITION_IN_SAVEPOSITION	0"
	"		TASK_FIND_BACKAWAY_FROM_SAVEPOSITION		0"
...
AI_DEFINE_SCHEDULE
(
	SCHED_BACK_AWAY_FROM_MELEE_ENEMY_FAIL,

	"	Tasks"
	"		TASK_SET_SCHEDULE		SCHEDULE:SCHED_RUN_FROM_ENEMY"
	""
	"	Interrupts"
	"		COND_NEW_ENEMY"
);
