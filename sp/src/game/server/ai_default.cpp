...
void CAI_BaseNPC::InitDefaultScheduleSR(void)
{
	...
	ADD_DEF_SCHEDULE( "SCHED_INVESTIGATE_SOUND_WALK",		SCHED_INVESTIGATE_SOUND_WALK);
	ADD_DEF_SCHEDULE( "SCHED_WALK_TO_SQUADLEADER",			SCHED_WALK_TO_SQUADLEADER);
	ADD_DEF_SCHEDULE( "SCHED_RUN_TO_SQUADLEADER",			SCHED_RUN_TO_SQUADLEADER);
	ADD_DEF_SCHEDULE( "SCHED_RETURN_TO_PRECOMBAT_POS_RUN",	SCHED_RETURN_TO_PRECOMBAT_POS_RUN);
	ADD_DEF_SCHEDULE( "SCHED_RETURN_TO_PRECOMBAT_POS_WALK",	SCHED_RETURN_TO_PRECOMBAT_POS_WALK);
	...
	ADD_DEF_SCHEDULE( "SCHED_BACK_AWAY_FROM_MELEE_ENEMY",	SCHED_BACK_AWAY_FROM_MELEE_ENEMY);
...
//	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_NONE);
	...
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_INVESTIGATE_SOUND_WALK);
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_WALK_TO_SQUADLEADER);
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_RUN_TO_SQUADLEADER);
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_RETURN_TO_PRECOMBAT_POS_RUN);
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_RETURN_TO_PRECOMBAT_POS_WALK);
	...
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_BACK_AWAY_FROM_MELEE_ENEMY);
...
//	"		TASK_SET_TOLERANCE_DISTANCE		16"
	"		TASK_GET_PATH_TO_BESTSOUND_LOS	0"
//	"		TASK_RUN_PATH					0"
...
AI_DEFINE_SCHEDULE
(
	SCHED_WALK_TO_SQUADLEADER,

	"	Tasks"
	"		TASK_STOP_MOVING				0"
	"		TASK_GET_PATH_TO_SQUADLEADER	0"
	"		TASK_FACE_IDEAL					0"
	"		TASK_WALK_PATH_WITHIN_DIST		150"
	"		TASK_WAIT_FOR_MOVEMENT			0"
	"		TASK_STOP_MOVING				0"
	"		TASK_FACE_RANDOM				0"
	"		TASK_WAIT_FOR_MOVEMENT			0"
...
AI_DEFINE_SCHEDULE
(
	SCHED_RETURN_TO_PRECOMBAT_POS_RUN,

	"	Tasks"
	"		TASK_STOP_MOVING				0"
	"		TASK_GET_PATH_TO_PRECOMBATPOS	0"
	"		TASK_FACE_IDEAL					0"
	"		TASK_RUN_PATH_WITHIN_DIST		200"
	"		TASK_WAIT_FOR_MOVEMENT			0"
	"		TASK_STOP_MOVING				0"
...
AI_DEFINE_SCHEDULE
(
	SCHED_RETURN_TO_PRECOMBAT_POS_WALK,

	"	Tasks"
	"		TASK_STOP_MOVING				0"
	"		TASK_GET_PATH_TO_PRECOMBATPOS	0"
	"		TASK_FACE_IDEAL					0"
	"		TASK_WALK_PATH_WITHIN_DIST		200"
	"		TASK_WAIT_FOR_MOVEMENT			0"
	"		TASK_STOP_MOVING				0"
	"		TASK_FACE_RANDOM				0"
	"		TASK_WAIT_FOR_MOVEMENT			0"
...
AI_DEFINE_SCHEDULE
(
	SCHED_BACK_AWAY_FROM_MELEE_ENEMY,
