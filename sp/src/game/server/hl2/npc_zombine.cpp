...
public:
	...
	void InputEnableGrenadePull ( inputdata_t &inputdata );
	void InputDisableGrenadePull ( inputdata_t &inputdata );
...
BEGIN_DATADESC( CNPC_Zombine )
	...
	DEFINE_INPUTFUNC( FIELD_VOID,	"EnableGrenadePull",  InputEnableGrenadePull ),
	DEFINE_INPUTFUNC( FIELD_VOID,	"DisableGrenadePull",  InputDisableGrenadePull ),
END_DATADESC()
...
void CNPC_Zombine::InputEnableGrenadePull ( inputdata_t &inputdata )
{
	if ( m_iGrenadeAlwd == 0 )
	{
		m_iGrenadeAlwd = 1;
...
void CNPC_Zombine::InputDisableGrenadePull ( inputdata_t &inputdata )
{
	if ( m_iGrenadeAlwd == 1 )
	{
		m_iGrenadeAlwd = 0;
