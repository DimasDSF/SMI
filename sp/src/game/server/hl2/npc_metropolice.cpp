...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_MetroPolice::InputClearPoliceGoal( inputdata_t &inputdata )
{
...
(
	...
	"	Tasks"
	"		TASK_STOP_MOVING				0"
	"		TASK_FACE_TARGET				0.1"	//FIXME: This needs to be the target or enemy/it was TASK_FACE_PLAYER
