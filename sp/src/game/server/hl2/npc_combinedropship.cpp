...
BEGIN_DATADESC( CNPC_CombineDropship )
	...
	DEFINE_KEYFIELD( m_sNPCTemplate[6], FIELD_STRING,	"NPCTemplate7" ),
	DEFINE_KEYFIELD( m_sNPCTemplate[7], FIELD_STRING,	"NPCTemplate8" ),
	DEFINE_KEYFIELD( m_sNPCTemplate[8], FIELD_STRING,	"NPCTemplate9" ),
	DEFINE_KEYFIELD( m_sNPCTemplate[9], FIELD_STRING,	"NPCTemplate10" ),
	DEFINE_KEYFIELD( m_sNPCTemplate[10], FIELD_STRING,	"NPCTemplate11" ),
	DEFINE_KEYFIELD( m_sNPCTemplate[11], FIELD_STRING,	"NPCTemplate12" ),
	...
	DEFINE_KEYFIELD( m_sDustoffPoints[6], FIELD_STRING,	"Dustoff7" ),
	DEFINE_KEYFIELD( m_sDustoffPoints[7], FIELD_STRING,	"Dustoff8" ),
	DEFINE_KEYFIELD( m_sDustoffPoints[8], FIELD_STRING,	"Dustoff9" ),
	DEFINE_KEYFIELD( m_sDustoffPoints[9], FIELD_STRING,	"Dustoff10" ),
	DEFINE_KEYFIELD( m_sDustoffPoints[10], FIELD_STRING,	"Dustoff11" ),
	DEFINE_KEYFIELD( m_sDustoffPoints[11], FIELD_STRING,	"Dustoff12" ),
