...
void CAI_BaseNPC::InitDefaultTaskSR(void)
{
	...
	ADD_DEF_TASK( TASK_GET_PATH_TO_BESTSOUND_LOS );
	ADD_DEF_TASK( TASK_GET_PATH_TO_BESTSCENT );
	ADD_DEF_TASK( TASK_GET_PATH_TO_SQUADLEADER );
	ADD_DEF_TASK( TASK_GET_PATH_TO_PRECOMBATPOS );
