...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	ADD_ACTIVITY_TO_SR( ACT_RUN_PASSIVE );
	ADD_ACTIVITY_TO_SR( ACT_WALK_PASSIVE );
	...
	ADD_ACTIVITY_TO_SR( ACT_VM_DRAWEMPTY );
	ADD_ACTIVITY_TO_SR( ACT_VM_HOLSTER );
	ADD_ACTIVITY_TO_SR( ACT_VM_HOLSTEREMPTY );
...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_SHOTGUN_PUMP_EMPTY );
	ADD_ACTIVITY_TO_SR( ACT_SHOTGUN_PUMP_NOSHELL );
	ADD_ACTIVITY_TO_SR( ACT_SHOTGUN_PUMP_NOSHELL_EMPTY );
